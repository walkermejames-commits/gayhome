...
This branch adds `migrations/0004_phase6_platform_expansion.sql` and `migrations/down/0004_phase6_platform_expansion.down.sql`. It is additive and tested against an empty Phase 3 schema, a seeded Kent Phase 3 schema, rollback and reapplication. The proof preserves 60 services, one synthetic case and one synthetic permission.
