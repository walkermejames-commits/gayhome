...
- Integrated files: `migrations/0006_phase6_platform_expansion.sql` and `migrations/down/0006_phase6_platform_expansion.down.sql`; source branch filenames were renumbered before application because Phase 4 owns `0004` and Phase 5 owns `0005`.
